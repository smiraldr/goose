...
| [IO Intelligence](https://io.net/)                                          | Inference for open-weight models (DeepSeek, Qwen, Llama, GLM, Kimi, gpt-oss and more) through io.net's OpenAI-compatible API. Models are discovered from the API. | `IONET_API_KEY` |
